  ...
  useEffect(() => {
    ...
    function buildFigures(players: ScenePlayer[], myId: string | null) {
      ...
      players.forEach((pl, i) => {
        ...
        const seat: Seat = { id: pl.id, name: pl.name, human: false, pos: new THREE.Vector3(x, 0, z), bodyYaw, grp, body: bodyGrp, head, skull, animPhase: i * 1.7, skinMat, bodyMat, accentMat, ring, label, tag, tagMat, tagKey: '', baseColor, alive: pl.alive, deathAnim: pl.alive ? 0 : 1, deathInit: !pl.alive, fallAxis: null };
